...
--- *Main> byp (Union' [Letter'  'a', Letter' 'a', Zero])
--- False
--- *Main> byp (Union' [Star' (Letter'  'a'), Star' (Letter'  'b')])
--- True
--- *Main> byp (Cat'  [Star' (Letter'  'a'), Letter' 'b'])
--- False
--- *Main> byp (Cat'  [Star' (Letter'  'a'), Zero])
--- False
--- *Main> byp (Star' (Letter'  'a'))
--- True
...
deriv a Zero = Zero
deriv a One = Zero
deriv a (Letter' s) = if a == s then One else Zero
deriv a (Union' []) = Zero
deriv a (Union' [r]) = deriv a r
deriv a (Union' (r:rs)) = Union' [(deriv a r), (deriv a (Union' rs))] 
deriv a (Cat' []) = Zero
deriv a (Cat' [r]) = deriv a r
deriv a (Cat' (r:rs)) = if byp r then Union' [ Cat' ([(deriv a r)] ++ rs), (deriv a (Union' rs))] else Cat' ([(deriv a r)] ++ rs)
...
--deriv 'a' (re "aab+@*+.bab+@*+.+")
--Union' [Cat' [One,Union' [Union' [Letter' 'a',Letter' 'b'],Star' (Letter' '@')]],Cat' [Zero,Union' [Union' [Letter' 'a',Letter' 'b'],Star' (Letter' '@')]]]
--simp (deriv 'a' (re "aab+@*+.bab+@*+.+"))
-- Union' [Letter' 'a',Letter' 'b',Star' (Letter' '@')]
...
conv :: RE' -> FSM RE'
conv r = FSM{states=qs, start=r, finals=fs, delta=d} where
			qs = undefined
			---qs = sort $ stable $ iterate close ([r], [])
			fs = undefined
			d = undefined
...
--- conv Zero = undefined
---conv One = undefined
---conv (Letter' a) = undefined
---conv (Union' r) = undefined
---conv (Cat' r) = undefined
--conv (Star' r) = undefined
